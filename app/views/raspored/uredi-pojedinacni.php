...
<div class="main-content">
    <div style="background: #fff; padding: 30px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); max-width: 600px; margin: 0 auto;">
        ...
        <!-- Info card -->
        <div style="background: linear-gradient(135deg, #3498db, #2980b9); padding: 20px; border-radius: 8px; color: white; margin-bottom: 25px;">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <small style="display: block; margin-top: 8px; color: #7f8c8d;">
                    Trenutna smjena: <strong><?= ucfirst($raspored['smjena']) ?></strong>
                </small>
            </div>
